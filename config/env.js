...
const env = {
  ...
  BACKLOGS_SUMMARY_RANGE: process.env.BACKLOGS_SUMMARY_RANGE || "J10:J11",
  BACKLOGS_CONTRIBUTORS_RANGE:
    process.env.BACKLOGS_CONTRIBUTORS_RANGE || "I2:J8",
  BACKLOGS_CLUSTER_RANGES_JSON:
    process.env.BACKLOGS_CLUSTER_RANGES_JSON || "",
  TRUCK_REQUEST_TAB_NAME:
    process.env.TRUCK_REQUEST_TAB_NAME || DEFAULT_TRUCK_REQUEST_TAB_NAME,
  TRUCK_REQUEST_RANGE: process.env.TRUCK_REQUEST_RANGE || "B3:K",
